...
var REST_ROOT     = 'https://api.twitter.com/1.1/'
  ...
  , SEARCH_ROOT   = 'https://search.twitter.com/'
...
Twitter.prototype = {
  ...
  stream: function (path, params) {
    var ROOT = STREAM_ENDPOINT_MAP[path]
    ...
    return new OARequest(this.auth, 'GET', ROOT + path, this.normalizeParams(params)).persist()
  },
  search: function (params, callback) {
    this.request('GET', SEARCH_ROOT + 'search', params, callback)
  },
  request: function (method, path, params, callback) {
    ...
    return new OARequest(this.auth, method, path, this.normalizeParams(params)).end(callback)
  },
